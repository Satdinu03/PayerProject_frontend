        ...
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            {role === 'agent' && (
              <>
                <button
                  onClick={() => navigate('/agent/plan-shopper', { state: { openChat: true } })}
                  className="text-white hover:text-blue-100 font-medium"
                >
                  Plan Shopper
                </button>
                <button
                  onClick={() => navigate('/agent/benefit-inquiry', { state: { openChat: true } })}
                  className="text-white hover:text-blue-100 font-medium"
                >
                  Benefit Inquiry
                </button>
            ...
            {role === 'member' && (
              <button
                onClick={() => navigate('/member/benefit-inquiry', { state: { openChat: true } })}
                className="text-white hover:text-blue-100 font-medium"
              >
                Benefit Inquiry
              </button>
